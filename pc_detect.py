...
def load_user_data(face_dataset_dir, qr_dataset_dir):
    ...
    for user_name in os.listdir(face_dataset_dir):
        ...
        user_data[user_id] = {
            ...
            # Assume authorization if QR code is present
            'authorized': qr_code_data is not None
        }
    ...
    while True:
        ...
        for qr_code in qr_codes:
            ...
            if user_id is not None:
                ...
                cv2.putText(
                    frame, f"{status}", (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
                draw_boundary(
                frame, face_cascade, 1.1, 10, (255, 0, 0), "Face", recognizer)
                break
